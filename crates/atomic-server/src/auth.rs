...
mod tests {
    ...
    fn test_app_state() -> (web::Data<AppState>, String) {
        ...
        let state = web::Data::new(AppState { manager, event_tx, public_url: None, log_buffer: crate::log_buffer::LogBuffer::new(0), sync_running: std::sync::Arc::new(tokio::sync::Mutex::new(std::collections::HashSet::new())) });
